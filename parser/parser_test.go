...
You will love it.`)
	...
	is.Equal(greetInputObject.Fields[0].Name, "Query")
	is.Equal(greetInputObject.Fields[0].NameLowerCamel, "query")
	is.Equal(greetInputObject.Fields[0].NameLowerSnake, "query")
	is.Equal(greetInputObject.Fields[0].Comment, "Query describes which page of data to get.")
